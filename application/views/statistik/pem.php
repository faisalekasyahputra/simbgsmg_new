                    ...
                    <div class="row ">
                        <div class="col ">
                            <ul class="nav nav-pills d-flex flex-column " id="myTab" role="tablist">
                                ...
                                <button class="nav-link nav-link-tab  primary-color m-2 btn  glass text-start" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false"><i class="fa fa-plus me-2" aria-hidden="true"></i> Jumlah Institusi</button>

                                <button class="nav-link nav-link-tab  primary-color m-2 btn  glass text-start" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false"><i class="fa fa-scissors me-2" aria-hidden="true"></i> Klasifikasi Bangunan Gedung</button>

                                <button class="nav-link nav-link-tab  primary-color m-2 btn  glass text-start" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false"><i class="fa fa-database me-2" aria-hidden="true"></i> Pendataan Teknis</button>
